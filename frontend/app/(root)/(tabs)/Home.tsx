...
import { Text, SafeAreaView, FlatList, View, Image, ActivityIndicator, TouchableOpacity } from 'react-native'
        ...
        <FlatList
            ...
            ListEmptyComponent={()=>(
                <View className='flex flex-col justify-center items-center'>
                    {!loading ?(
                        <>
                        <Image className='w-40 h-40 ' alt='No recent rides found' resizeMode="contain" source={images.noResult}/>
